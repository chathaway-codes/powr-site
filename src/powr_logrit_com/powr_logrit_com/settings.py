# Django settings for powr_logrit_com project.
import os
...
SECRET_KEY = '(s03a8=2-xo19l*!$b*asiacq7!i-$uewk6gmy!mstoy#z$#qa'
...
ROOT_URLCONF = 'powr_logrit_com.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'powr_logrit_com.wsgi.application'
